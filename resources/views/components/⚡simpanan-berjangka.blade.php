        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-6 min-h-[80px]">Sejumlah uang yang wajib dibayarkan oleh anggota kepada
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100 mb-6">
                        <span class="text-xs text-gray-500 font-bold uppercase tracking-wider block mb-1">Jumlah
                            Setoran</span>
                        <div class="text-3xl font-bold text-brand-red">Rp 100.000,-</div>
                        <span class="text-xs text-gray-400 mt-1 block">Dibayarkan 1x seumur hidup</span>
                    </div>
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-6 min-h-[80px]">Sejumlah uang yang wajib dibayarkan oleh anggota kepada
                        koperasi setiap bulannya secara rutin. Dana ini dikelola untuk pembiayaan produktif anggota
                        lain.
                    </p>
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100 mb-6">
                        <span class="text-xs text-gray-500 font-bold uppercase tracking-wider block mb-1">Jumlah
                            Setoran</span>
                        <div class="text-3xl font-bold text-brand-orange">Rp 25.000,-</div>
                    ...
                    <ol class="space-y-4 text-gray-700">
                        ...
                        <li class="flex items-start gap-3">
                            <div
                                class="w-6 h-6 rounded-full bg-brand-red text-white flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
                                4</div>
                            <p>Melengkapi dokumen pendaftaran (Fotokopi KTP dan Kartu Keluarga).</p>
                        </li>
                        <li class="flex items-start gap-3">
                            <div
                                class="w-6 h-6 rounded-full bg-brand-red text-white flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
