        ...
        <div class="container mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center gap-12">
            ...
            <div class="lg:w-2/5 animate-float hidden md:block relative">
                ...
                <div
                    ...
                    <img src="/hadiah-umroh.jpeg" class="w-full  object-cover" alt="Makkah">
                ...
                <div
                    class="absolute -bottom-10 -left-20 w-64  rounded-xl shadow-2xl z-20 transform -rotate-12 border border-yellow-300 flex flex-col justify-between">
